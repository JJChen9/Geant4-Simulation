...
// ********************************************************************
//
// $Id: myPhysicsList.cc 66892 2013-01-17 10:57:59Z gunter $
//
//---------------------------------------------------------------------------
//
...
#include "../include/myPhysicsList.hh"
#include "globals.hh"
...
myPhysicsList::myPhysicsList( G4int ver, const G4String&)
{
 // G4DataQuestionaire it(photon, neutronxs);
  G4cout << "<<< Reference Physics List myPhysicsList "
	 <<G4endl;	
