...
//////////////////////////////////////////////////////////////////////////////////////// Inner Part parameters
    ...
    G4double InnerSide_l = 159.24*mm ;//forward doesn't have physics meaning, just later change to move everything forward
    G4double InnerSide_Z = 5.847*25.4*mm;
    ...
    G4double  rHalf_Pb = (5.939*25.4*mm -InnerFront_l - 2*Half_Cu)/2;
    
    G4double distance = 2*fHalf_Pb + 2.5*25.4*mm;
    G4double FrontAl_Z1  = InnerSide_Z + Half_Al;
    G4double FrontCu_Z1  = InnerSide_Z + Half_Cu;
    G4double FrontPb_Z1  = FrontCu_Z1 + Half_Cu + fHalf_Pb;
    G4double FrontCu_Z2  = FrontCu_Z1 + Half_Cu + 2*fHalf_Pb + Half_Cu;
    G4double FrontPb_Z2  = FrontPb_Z1 + distance;
   
    G4double FrontCu_Z3  = FrontPb_Z1 + distance - fHalf_Pb - Half_Cu;
    G4double FrontCu_Z4  = FrontPb_Z1 + distance + fHalf_Pb + Half_Cu;
   ...
   // G4double InnerSideBL_Z= (16.94+3)*25.4*mm ; // Need number for gage
    G4double InnerSideBL_Z= 25*25.4*mm  - InnerSide_Z - 2.3*25.4*mm;
    ...
    G4double Z_LaBr = FrontCu_Z4 + Half_Cu ;
    
    G4double InnerSideSExtZ = InnerSideBL_Z/2 + 2*InnerSide_Z + 3.3*25.4*mm ;
...
//LaBr Crystal
  ...
  new G4PVPlacement(
                 0,
                 G4ThreeVector(offset_Spot+offset_LaBr, 0., Z_LaBr+WindowD+AirD+LaBr_CrystalL/2),
...
//LaBr EndCup
  ...
  new G4PVPlacement(
                 0,
                 G4ThreeVector(offset_Spot+offset_LaBr, 0., Z_LaBr+LaBr_EndcupL/2  ),
                 LaBr_fEndcupLV,
                 "LaBr_fEndcupPV",
                 worldLV,
                 false,
...
//LaBr Window
  ...
  new G4PVPlacement(
                 0,
                 G4ThreeVector(offset_Spot+offset_LaBr, 0., Z_LaBr+WindowD/2 ),
                 WindowLVLaBr,
                 "fWindowPVLaBr",
                 worldLV,
                 false,
...
////////////////////////////////////////////////////////////////////////////////////////
  ...
  G4Box* LeadInnerS_L  = new G4Box("LeadInnerS_L", ((5.939-3.889)*25.4*mm-rHalf_Pb*2-Half_Cu*4)/2, height/2,(distance-fHalf_Pb*2)/2);
  ...
  G4LogicalVolume* LeadInnerSLVR = new G4LogicalVolume(LeadInnerS_R, LeadMaterial, "LeadInnerSLVR");
  G4LogicalVolume* LeadInnerSLVL = new G4LogicalVolume(LeadInnerS_L, LeadMaterial, "LeadInnerSLVL");
  G4LogicalVolume* LeadInnerSLVTrap = new G4LogicalVolume(LeadInnerS_B, LeadMaterial, "LeadInnerSLVTrap");
  ...
  G4LogicalVolume* LeadInnerFLV = new G4LogicalVolume(LeadInnerF, LeadMaterial, "LeadInnerFLV");
    ...
    new G4PVPlacement(
               0,
               G4ThreeVector(SidePb_X+rHalf_Pb+3.889*25.4*mm +((5.939-3.889)*25.4*mm-rHalf_Pb*2)/2 -1.2*Half_Cu ,offset_Y, FrontCu_Z2 + (FrontCu_Z3-FrontCu_Z2)/2),
               LeadInnerSLVL,
               "LeadInnerSPVL",
               worldLV,
               false,
...
////////////////////////////////////////////////////////////////////////////////////////
  ...
  G4LogicalVolume* CopperInnerSLVF = new G4LogicalVolume(CopperInnerS_F_edge, CopperMaterial, "CopperInnerSLVF");
  G4LogicalVolume* CopperInnerSLVB = new G4LogicalVolume(CopperInnerS_F_edge, CopperMaterial, "CopperInnerSLVB");
    
  G4LogicalVolume* CopperInnerSLVL = new G4LogicalVolume(CopperInnerS_F, CopperMaterial, "CopperInnerSLVL");
  G4LogicalVolume* CopperInnerSLVR = new G4LogicalVolume(CopperInnerS_F, CopperMaterial, "CopperInnerSLVR");
  ...
  G4PVPlacement* CopperInnerFPV3 =
  new G4PVPlacement(
             0,
             G4ThreeVector(Finner_X, offset_Y, FrontCu_Z3),
             CopperInnerFLV,
             "CopperInnerFPV3",
             worldLV,
             false,
    ...
    G4PVPlacement* CopperInnerFPV4 =
    new G4PVPlacement(
               0,
               G4ThreeVector(Finner_X, offset_Y, FrontCu_Z4),
               CopperInnerFLV,
               "CopperInnerFPV4",
               worldLV,
               false,
    ...
    new G4PVPlacement(
               0,
               G4ThreeVector(SidePb_X, offset_Y, FrontCu_Z1),
               CopperInnerSLVF,
               "CopperInnerSPVF",
               worldLV,
               false,
    ...
    new G4PVPlacement(
               0,
               G4ThreeVector(SidePb_X, offset_Y, FrontCu_Z4),
               CopperInnerSLVB,
               "CopperInnerSPVB",
               worldLV,
               false,
    ...
    new G4PVPlacement(
               0,
               G4ThreeVector( SideCu_X1 + (3.889*25.4*mm - 2*Half_Cu), offset_Y, FrontCu_Z2 + (FrontCu_Z3-FrontCu_Z2)/2),
               CopperInnerSLVL,
               "CopperInnerSPVL",
               worldLV,
               false,
      ...
      new G4PVPlacement(
                 0,
                 G4ThreeVector(SideCu_X1, offset_Y, FrontCu_Z2 + (FrontCu_Z3-FrontCu_Z2)/2),
                 CopperInnerSLVR,
                 "CopperInnerSPVR",
                 worldLV,
                 false,
...
//G4double Wdepth_f       = 2*25.4*mm; // f means front part of Tungsten
  ...
  G4double fCu_x  = fPb_lengthT;
  G4double fBP1_x = fCu_x;
  G4double fPb_x  = fBP1_x;
  G4double fBP2_x = fPb_x;
  
  G4double f_delta_y = 5.3*25.4*mm;
//G4double f_delta_y = 7.5*25.4*mm; Need to update
  
    

  G4double fCu_y     = 6.0*25.4*mm;
  G4double fBP1_y    = height+ copperdepth*2 + leaddepth*3 + BPdepth2*2 +  aluminumdepth*2 + BPdepth*2 + Top_Leak + leaddepth1;
  G4double fPb_y     = fBP1_y;
  G4double fBP2_y    = fPb_y;
    
//G4double front_dY  = 0.27*25.4*mm;
  G4double front_dY  = fBP1_y/2 - (height/2 + copperdepth + leaddepth*2 + BPdepth2*2)  ;
  ...
  //的r_HPGe和r_LaBr都要加上1*cm,最好不要用 3*r_LaBr(原本的数值）
   ...
   G4LogicalVolume* CopperFwallLV = new G4LogicalVolume(CopperFwall, CopperMaterial, "CopperFwallLV");
      ...
      new G4PVPlacement(
                 0,
                 G4ThreeVector(fW_x, 0, - copperdepth/2),
                 CopperFwallLV,
                 "CopperFwallPV",
                 worldLV,
                 false,
...
G4double support_Lowerhole_Ylength = 3.6*25.4*mm;
...
//G4double f_delta_y    = 5*25.4*mm; //如果不是只看Top shielding的话,记得注释掉这句话
  ...
  G4double Top_Gap_Left  = 0.5*25.4*mm;
  G4double Top_Gap_Right = 0.52*25.4*mm;

  G4double Top_Gap_Total = Top_Gap_Left + Top_Gap_Right;
  G4double T_XHole       = fPb_lengthT  + Top_Gap_Total; //T_XHole = 23.78*25.4*mm;
//G4double T_ZHole       =  7.6*25.4*mm;
  G4double T_ZHole       =  Whole_front_thickness_in_Z;
  G4double Top_Bar_Left  =  3*25.4*mm;
  G4double Top_Bar_Right =  3.5*25.4*mm;
  G4double containerdepth=  0.75*25.4*mm;
  G4double T_Xlength =fPb_lengthT+Top_Bar_Left+Top_Gap_Left+Top_Gap_Right+Top_Bar_Right;
  G4double T_Zlength      = 35.5*25.4*mm;
  G4double T_Xlength2     = 53.2*25.4*mm; //T_Xlength2 > T_Xlength
  G4double tTheta=-atan((T_Xlength2-T_Xlength)/2/T_Zlength);
  G4double T_dX = -(T_Xlength + T_Xlength2)/4 + Top_Bar_Left + Top_Gap_Left + fPb_lengthT/2 + fW_x ;
  G4double T_dZ = T_Zlength/2 - T_ZHole ;
  G4double Cut_dX=(T_Xlength+T_Xlength2)/4-Top_Bar_Left-(fPb_lengthT+Top_Gap_Left+Top_Gap_Right)/2;
  G4double Cut_dZ= -(T_Zlength-T_ZHole)/2 - 0.01 ;
 ...
 // if(f_delta_y == 0) Movement = 8*25.4*mm;
   ...
   G4SubtractionSolid* AluminumTwall = new G4SubtractionSolid("AluminumTwall", AluminumTwallLayer, AluminumTwallHole, 0,
   G4ThreeVector(Cut_dX, 0, Cut_dZ) );
 //G4ThreeVector((2*T_Xlength + T_Zlength - 6*fPb_length - 2*T_XHole)/4 + 20*mm  ,0,-(T_Zlength-T_ZHole)/2-0.01 - Movement)); // Need update 20*mm
   ...
   G4LogicalVolume* AluminumTwallLV = new G4LogicalVolume(AluminumTwall, AluminumMaterial, "AluminumTwallLV");
     ...
     AluminumTwallPV1 =
      new G4PVPlacement(
               ...
               //G4ThreeVector(-(T_Xlength + T_Xlength2)/4, 0,0),
                 G4ThreeVector(T_dX, offset_Y + height/2 + Top_Leak + containerdepth/2, T_dZ),
                AluminumTwallLV,
                 "AluminumTwallPV",
                 worldLV,
                 false,
     ...
     AluminumTwallPV2 =
      new G4PVPlacement(
                 0,
                 G4ThreeVector(T_dX, offset_Y + height/2 + Top_Leak + 3*containerdepth/2 + copperdepth+ 3*leaddepth/2 +2*BPdepth, T_dZ),
                 AluminumTwallLV,
                 "AluminumTwallPV",
                 worldLV,
                 false,
...
/////////////////////
   ...
   G4LogicalVolume* CopperTwallLV = new G4LogicalVolume(CopperTwall, CopperMaterial, "CopperTwallLV");
      ...
      new G4PVPlacement(
                 0,
                 G4ThreeVector(T_dX, offset_Y + height/2 + Top_Leak + containerdepth +copperdepth/2, T_dZ),
                 CopperTwallLV,
                 "CopperTwallPV",
                 worldLV,
                 false,
...
/////////////////////
   ...
   G4LogicalVolume* LeadTwallLV1 = new G4LogicalVolume(LeadTwall1, LeadMaterial, "LeadTwallLV1");
      ...
      new G4PVPlacement(
                 0,
                 G4ThreeVector(T_dX, offset_Y + height/2 + Top_Leak + containerdepth + copperdepth+leaddepth/2, T_dZ),
                 LeadTwallLV1,
                 "LeadTwallPV1",
                 worldLV,
                 false,
...
/////////////////////
   ...
   G4LogicalVolume* LeadTwallLV2 = new G4LogicalVolume(LeadTwall2, LeadMaterial, "LeadTwallLV2");
      ...
      new G4PVPlacement(
                 0,
                 G4ThreeVector(T_dX, offset_Y + height/2 + Top_Leak + containerdepth + copperdepth + +BPdepth + 5*leaddepth/4, T_dZ),
                 LeadTwallLV2,
                 "LeadTwallPV2",
                 worldLV,
                 false,
...
/////////////////////
   ...
   G4LogicalVolume* BPTwallLV = new G4LogicalVolume(BPTwall, BPMaterial, "BPTwallLV");
      ...
      new G4PVPlacement(
                 0,
                 G4ThreeVector(T_dX, offset_Y + height/2 + Top_Leak + containerdepth + copperdepth+ leaddepth +BPdepth/2, T_dZ),
                 BPTwallLV,
                 "BPTwallPV1",
                 worldLV,
                 false,
      ...
      new G4PVPlacement(
                 0,
                 G4ThreeVector(T_dX, offset_Y + height/2 + Top_Leak + containerdepth + copperdepth+ 3*leaddepth/2 +3*BPdepth/2, T_dZ ),
                 BPTwallLV,
                 "BPTwallPV1",
                 worldLV,
                 false,
...
/*
  G4Trap* AirTwallLayer = new G4Trap( "AirTwallLayer",
   ...
   G4SubtractionSolid* AirTwall = new G4SubtractionSolid("AirTwall", AirTwallLayer, AirTwallHole, 0, G4ThreeVector(Cut_dX,0,Cut_dZ));
   ...
   G4LogicalVolume* AirTwallLV = new G4LogicalVolume(AirTwall,  WorldMaterial, "AirTwallLV");
      ...
      new G4PVPlacement(
                 0,
                 G4ThreeVector(T_dX, offset_Y + height/2 + Top_Leak/2,  T_dZ ),
                 AirTwallLV,
                 "AirTwallPV",
                 worldLV,
                 false,
...
*/
    ...
    G4double SkirtL_H =2   *25.4*mm;
    G4double SkirtL_L =21.2*25.4*mm;
    G4double SkirtL_W =0.5 *25.4*mm;
    G4double SkirtL_W2=2   *25.4*mm;
    
    G4double SLdX    =307.38*mm + SkirtL_W/2;
    G4double SLdX2   =307.38*mm + SkirtL_W + SkirtL_W2/2;
    G4double SLdY    =offset_Y + height/2 + Top_Leak/2 - (SkirtL_H/2 -Top_Leak/2);
    G4double SLdZ    =fW_z_1 - Wdepth_b + 6.66*25.4*mm + SkirtL_L/2;
    
    
    G4Box* CopperskirtL = new G4Box("CopperskirtL", SkirtL_W/2, SkirtL_H/2, SkirtL_L/2);
    G4LogicalVolume* CopperskirtLLV= new G4LogicalVolume(CopperskirtL, CopperMaterial, "CopperskirtLLV");
    CopperskirtLPV=
    new G4PVPlacement(
               0,
               G4ThreeVector(SLdX, SLdY, SLdZ),
               CopperskirtLLV,
               "CopperskirtLPV",
               worldLV,
               false,
    ...
    G4LogicalVolume* LeadskirtLLV= new G4LogicalVolume(LeadskirtL, LeadMaterial, "LeadskirtLLV");
    LeadskirtLPV=
    new G4PVPlacement(
               0,
               G4ThreeVector(SLdX2, SLdY, SLdZ),
               LeadskirtLLV,
               "LeadskirtLPV",
               worldLV,
               false,
    ...
    G4double SkirtR_X1 =SkirtL_W ;
    G4double SkirtR_X2 =SkirtL_W2;
    G4double SkirtR_Z  =SkirtL_L;
    G4double SkirtR_Y  =SkirtL_H;
    G4double rTheta0=(-45)*degree;
  
    G4double SRdX    =-321.524*mm - (SkirtR_Z*sqrt(2)-3*SkirtR_X1)/(2*sqrt(2)) - SkirtR_X1 *sqrt(2)* 1.2;
    G4double SRdX2   =SRdX  - SkirtR_X1*sqrt(2)/2 - SkirtL_W2*sqrt(2)/2;
    G4double SRdY    =SLdY;
    G4double SRdZ    =SLdZ;
   ...
   G4LogicalVolume* CopperskirtRLV= new G4LogicalVolume(CopperskirtR, CopperMaterial, "CopperskirtRLV");
      
   CopperskirtRPV=
   new G4PVPlacement(
             0,
             G4ThreeVector(SRdX, SRdY, SRdZ),
             CopperskirtRLV,
             "CopperskirtRPV",
             worldLV,
             false,
    ...
    G4LogicalVolume* LeadskirtRLV= new G4LogicalVolume(LeadskirtR, LeadMaterial, "LeadskirtRLV");
    LeadskirtRPV=
    new G4PVPlacement(
                0,
                G4ThreeVector(SRdX2, SRdY, SRdZ),
                LeadskirtRLV,
                "LeadskirtRPV",
                worldLV,
                false,
    ...
    G4double SkirtR_H = SkirtL_H;
    G4double SkirtR2_L= 2.5*25.4*mm;
    G4double SR2dX    =-321.524*mm - SkirtR_X1 *sqrt(2)/2;
    G4double SR2dX2   =SR2dX        -SkirtR_X1 *sqrt(2)/2  - SkirtR_X2*sqrt(2)/2;
    G4double SR2dY    =SLdY;
    G4double SR2dZ    =SLdZ - SkirtL_L/2 - SkirtR2_L/2;
    
    
    G4Box* CopperskirtR2 = new G4Box("CopperskirtR2", SkirtR_X1*sqrt(2)/2, SkirtR_H/2, SkirtR2_L/2);
    G4LogicalVolume* CopperskirtR2LV= new G4LogicalVolume(CopperskirtR2, CopperMaterial, "CopperskirtR2LV");
    CopperskirtR2PV=
    new G4PVPlacement(
              0,
              G4ThreeVector(SR2dX, SR2dY, SR2dZ),
              CopperskirtR2LV,
              "CopperskirtR2PV",
              worldLV,
              false,
    ...
    G4LogicalVolume* LeadskirtR2LV= new G4LogicalVolume(LeadskirtR2, LeadMaterial, "LeadskirtR2LV");
    LeadskirtR2PV=
    new G4PVPlacement(
                0,
                G4ThreeVector(SR2dX2, SR2dY, SR2dZ),
                LeadskirtR2LV,
                "LeadskirtR2PV",
                worldLV,
                false,
...
/*
    ...
    G4double TopGap_LBlockX = 2*25.4*mm;
    G4double TopGap_LBlockY = 2*25.4*mm;
    G4double TopGap_LBlockZ = 2*25.4*mm;
    G4double TopGLdX        = fW_x + leak + W_length/2 + fPb_lengthL + Top_Gap_Left/2;
    G4double TopGLdY        = W_height/2 + leak ;
    G4double TopGLdZ        = - Whole_front_thickness_in_Z -  TopGap_LBlockZ/2;
    G4Box* TopGap_LBlock = new G4Box("TopGap_LBlock", TopGap_LBlockX/2, TopGap_LBlockY/2, TopGap_LBlockZ/2);
    G4LogicalVolume* TopGap_LBlockLV= new G4LogicalVolume(TopGap_LBlock, LeadMaterial, "TopGap_LBlockLV");
    TopGap_LBlockPV=
    new G4PVPlacement(
                0,
                G4ThreeVector(TopGLdX, TopGLdY , TopGLdZ),
                TopGap_LBlockLV,
                "TopGap_LBlockPV",
                worldLV,
                false,
    ...
    G4double TopGap_RBlockX = 2*25.4*mm;
    G4double TopGap_RBlockY = 2*25.4*mm;
    G4double TopGap_RBlockZ = 2*25.4*mm;
    G4double TopGRdX        = fW_x - leak - W_length/2 - fPb_lengthR - Top_Gap_Right/2;
    G4double TopGRdY        = W_height/2 + leak;
    G4double TopGRdZ        = - Whole_front_thickness_in_Z- TopGap_LBlockZ/2;
    G4Box* TopGap_RBlock = new G4Box("TopGap_RBlock", TopGap_RBlockX/2, TopGap_RBlockY/2, TopGap_RBlockZ/2);
    G4LogicalVolume* TopGap_RBlockLV= new G4LogicalVolume(TopGap_RBlock, LeadMaterial, "TopGap_RBlockLV");
    TopGap_RBlockPV=
    new G4PVPlacement(
                0,
                G4ThreeVector(TopGRdX,TopGRdY,TopGRdZ),
                TopGap_RBlockLV,
                "TopGap_RBlockPV",
                worldLV,
                false,
...
//#########################Bottom Shielding Wall ###########################
    ...
    G4double floorTheta= -atan(0.5); //这个floor指的是底部的最大那块梯形面积
    G4double floor_Zlength = 28.4*25.4*mm;
    
    G4double floor_Xlength = fPb_lengthT;
    G4double floor_dX = - floor_Xlength/2 - floor_Zlength/4 + 264.12 *mm;//Unused Variable
    G4double floor_dZ = -0.5*25.4*mm;//- aluminumdepth - copperdepth - leaddepth2 - 2*BPdepth;//Unused Variable
...
//G4double bottemext_Xlength = fPb_lengthT; //unentangle with front shielding parameter since front size always changes
...
//For the UnionSolid or SubtractionSolid, the first object is the one which define the position instead of the whole object define the position
   ...
   G4LogicalVolume* LeadBwallLV = new G4LogicalVolume(LeadfloorwallLayer1, LeadMaterial, "LeadBwallLV");
      ...
      new G4PVPlacement(
                 0,
                 G4ThreeVector(floor_dX, -height/2  - copperdepth - 3*leaddepth/2 - BPdepth2 + offset_Y, floor_Zlength/2 + floor_dZ),
                 LeadBwallLV,
                 "LeadBwallPV2",
                 worldLV,
                 false,
   ...
   G4LogicalVolume* BPBwallLV = new G4LogicalVolume(BPfloorwallLayer, BPMaterial, "BPBwallLV");
      ...
      new G4PVPlacement(
                 0,
                 G4ThreeVector(floor_dX, -height/2  - copperdepth - leaddepth -BPdepth2/2 + offset_Y, floor_Zlength/2 + floor_dZ),
                 BPBwallLV,
                 "BPBwallPV1",
                 worldLV,
                 false,
      ...
      new G4PVPlacement(
                 0,
                 G4ThreeVector(floor_dX, -height/2  - copperdepth - 2*leaddepth - 3*BPdepth2/2 + offset_Y, floor_Zlength/2 + floor_dZ),
                 BPBwallLV,
                 "BPBwallPV2",
                 worldLV,
                 false,
...
//G4double right_dX= -(fPb_lengthT-fPb_lengthL-leak-3.9*25.4*mm-offset_Spot);
  ...
  G4double lr_length = 25*25.4*mm; //z方向上的长度，
   ...
   G4LogicalVolume* CopperRwallLV = new G4LogicalVolume(CopperRwallLayer, CopperMaterial, "CopperRwallLV");
      ...
      new G4PVPlacement(
                 0,
                 G4ThreeVector(right_dX , offset_Y, lr_length/2),
                 CopperRwallLV,                              
                 "CopperRwallPV",
                 worldLV,
                 false,
   ...
   G4LogicalVolume* LeadRwallLV = new G4LogicalVolume(LeadRwallLayer, LeadMaterial, "LeadRwallLV");
      ...
      new G4PVPlacement(
                 0,
                 G4ThreeVector(right_dX - copperdepth/sqrt(2) - leaddepth/sqrt(2), offset_Y, lr_length/2),
                 LeadRwallLV,                 
                 "LeadRwallPV1",
                 worldLV,
                 false,
      ...
      new G4PVPlacement(
                 0,
                 G4ThreeVector(right_dX - copperdepth/sqrt(2) - 3*leaddepth/sqrt(2) - 2*BPdepth2/sqrt(2), offset_Y, lr_length/2),
                 LeadRwallLV,
                 "LeadRwallPV2",
                 worldLV,
                 false,
   ...
   G4LogicalVolume* BPRwallLV = new G4LogicalVolume(BPRwallLayer, BPMaterial, "BPRwallLV");
      ...
      new G4PVPlacement(
                 0,
                 G4ThreeVector(right_dX - copperdepth/sqrt(2) - 2*leaddepth/sqrt(2) - BPdepth2/sqrt(2), offset_Y, lr_length/2),
                 BPRwallLV,
                 "BPRwallPV1",
                 worldLV,
                 false,
      ...
      new G4PVPlacement(
                 0,
                 G4ThreeVector(right_dX - copperdepth/sqrt(2) - 4*leaddepth/sqrt(2) - 3*BPdepth2/sqrt(2), offset_Y, lr_length/2),
                 BPRwallLV,
                 "BPRwallPV2",
                 worldLV,
                 false,
...
//#########################Left Shielding Wall ###########################
   ...
   G4LogicalVolume* CopperLwallLV = new G4LogicalVolume(CopperLwallLayer, CopperMaterial, "CopperLwallLV");
      ...
      new G4PVPlacement(
                 0,
                  ...
                  G4ThreeVector(left_dX, offset_Y, lr_length/2),
   ...
   G4LogicalVolume* LeadLwallLV = new G4LogicalVolume(LeadLwallLayer, LeadMaterial, "LeadLwallLV");
      ...
      new G4PVPlacement(
                 0,
                 G4ThreeVector(left_dX + copperdepth/2 + leaddepth/2, offset_Y, lr_length/2),
                 LeadLwallLV,
                 "LeadLwallPV1",
                 worldLV,
                 false,
      ...
      new G4PVPlacement(
                 0,
                 G4ThreeVector(left_dX + copperdepth/2 + leaddepth + BPdepth2 + leaddepth/2, offset_Y, lr_length/2),
                 LeadLwallLV,                            
                 "LeadLwallPV1",            
                 worldLV,
                 false,
   ...
   G4LogicalVolume* BPLwallLV = new G4LogicalVolume(BPLwallLayer, BPMaterial, "BPLwallLV");
      ...
      new G4PVPlacement(
                 0,
                 G4ThreeVector(left_dX + copperdepth/2 + leaddepth + BPdepth2/2, offset_Y, lr_length/2),
                 BPLwallLV,
                 "BPLwallPV1",
                 worldLV,
                 false,
      ...
      new G4PVPlacement(
                 0,
                 G4ThreeVector(left_dX + copperdepth/2 + leaddepth + BPdepth2 + leaddepth + BPdepth2/2, offset_Y, lr_length/2),
                 BPLwallLV,
                 "BPLwallPV2",
                 worldLV,
                 false,
